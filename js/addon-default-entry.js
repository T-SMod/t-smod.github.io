...
function _renderBlock(block, container, parentCategory, isVertical) {
  ...
  const COLOR_CLASSES = ["motion", "looks", "sounds", "events", "control", "sensing", "operators", "data", "data-lists", "list", "json", "console", "more", "pen", "addon-custom-block"];
